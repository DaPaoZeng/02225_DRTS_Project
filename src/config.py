...
# 基本路径配置
BASE_PATH = "/Users/jasonh/Desktop/02225_DRTS_Project/DRTS_Project-Test-Cases/10-unschedulable-test-case"  # 这里可以改成任何数据集文件夹路径
...
# 输出文件路径
OUTPUT_DIR = "/Users/jasonh/Desktop/02225_DRTS_Project/output/10-unschedulable-test-case"  # 输出文件存放的文件夹
